...
import { useGetPopularMoviesTans } from "@/modules/popularMovies/hooks/useGetPopularMovies";
import { AlertCircle, Film, LoaderCircle } from "lucide-react";
import { Link } from "react-router-dom";
export const PopularMovies = () => {
  const { movies, loading, isError } = useGetPopularMoviesTans();
  if (loading) {
    return (
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-center">
        <h1 className="flex text-4xl font-bold text-black">Popular Movies</h1>
      </div>
